...
<section class="call-to-action" style="height: 200px">
 <div class="container" style="margin-top: 70px;">
 <div class="row">
 <div class="col-md-3">
 <span class="glyphicon glyphicon-road glyphicon-large"
ariahidden="true"></span>
 <h3>Administration</h3>
 <p>Etiam porta sem malesuada magna mollis euismod.
Donec sed odio dui. Lorem ipsum dolor.</p>
 </div>
 <div class="col-md-3">
 <span class="glyphicon glyphicon-star glyphicon-large"
ariahidden="true"></span>
 <h3>Scholarships</h3>
 <p>Etiam porta sem malesuada magna mollis euismod.
Donec sed odio dui. Lorem ipsum dolor.</p>
 ...
 <div class="col-md-3">
 <span class="glyphicon glyphicon-flag glyphicon-large"
ariahidden="true"></span>
 <h3>Research</h3>
 <p>Etiam porta sem malesuada magna mollis euismod.
Donec sed odio dui. Lorem ipsum dolor.</p>
 ...
 <div class="col-md-3">
 <span class="glyphicon glyphicon-home glyphicon-large"
ariahidden="true"></span>
 <h3>Campus Life</h3>
 <p>Etiam porta sem malesuada magna mollis euismod.
Donec sed odio dui. Lorem ipsum dolor.</p>
