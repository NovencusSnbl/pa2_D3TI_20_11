...
public class TampilSemuaPemesanan extends AppCompatActivity implements ListView.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tampil_semua_pemesanan);
    ...
    private void showPesanan(){
        ...
        ListAdapter adapter = new SimpleAdapter(
                TampilSemuaPemesanan.this, list, R.layout.list_item,
    ...
    private void getJSON(){
        class GetJSON extends AsyncTask<Void,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(TampilSemuaPemesanan.this,"Mengambil Data","Mohon Tunggu...",false,false);
            }
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        Intent intent = new Intent(this, TampilPesanan.class);
