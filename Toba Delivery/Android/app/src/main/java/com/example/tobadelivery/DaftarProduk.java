...
public class DaftarProduk extends AppCompatActivity {
    ...
    private static final String URL_PRODUCTS = "http://169.254.168.218:8080/Proyek%20Akhir%202/Toba%20Delivery/Web/produkJSONData.php";
                        ...
                        try {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                productList.add(new Product(
                                        ...
                                        product.getDouble("harga"),
                                        product.getString("gambar")
                                ));
                            }

                            //creating adapter object and setting it to recyclerview
                            ProductsAdapter adapter = new ProductsAdapter(DaftarProduk.this, productList);
